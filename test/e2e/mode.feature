Feature: Using data-snap-mode to tell position where content should be loaded
  As a developer
  I want to be able to tell the position where content should be loaded relative to target element
